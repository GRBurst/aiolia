...
class FeedForwardNeuralNetworkSpec extends org.specs2.mutable.Specification {
  ...
  "single neuron" >> {
    ...
    n.compute_compiled(Array(0.2)) mustEqual Array(sigmoid(0.2 + 0.8))
  }
  "input and output not connected" >> {
    ...
    n.compute_compiled(Array(0.2)) mustEqual Array(sigmoid(2.1))
  }
  "one input -> one output" >> {
    ...
    n.compute_compiled(Array(0.7)) mustEqual Array(sigmoid(sigmoid(0.7 + 0.1) * (-0.7) + 0.2))
  }
  "two inputs -> one output" >> {
    ...
    n.compute_compiled(Array(0.7, 0.8)) mustEqual Array(sigmoid(sigmoid(0.7 + 0.1) * (-0.7) + sigmoid(0.8 + 0.2) * 0.4 + (-0.9)))
  }
  "skipping one layer" >> {
    ...
    n.compute_compiled(Array(0.7, 0.8)) mustEqual Array(v3)
  }
  ...
  "multiple inputs and outputs" >> {
    ...
    n.compute_compiled(Array(0.7, 0.8)) mustEqual Array(v3, v4)
  }
}
